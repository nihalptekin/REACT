...
{/* digest key ile bize 29 elemanli bir fizi geliyor biz onun 4 elemanini bastirmak icn önce slice ile dilimledik sonra da map ile cagirip bastirdik */}
...
<ImgContainer> 
<img src={a.recipe.image}/>   </ImgContainer>

<IngredContainer>{a.recipe.ingredientLines.map((item, index)=>(
  <div key={index}>
    <p>
     {index+1} * {item}
    </p>
