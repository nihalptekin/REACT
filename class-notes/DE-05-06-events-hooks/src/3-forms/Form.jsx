    ...
    <div className="container text-center mt-4">
      ...
      <form onSubmit={formAlindi}>
        ...
        <div className="mb-3">
          ...
          <input type="password" className="form-control" id="password" onInput={(e) => setPass(e.target.value)}/>
        </div>
        ...
        <div className="mb-3">
          ...
          <select className="form-select" aria-label="Default select example" onInput={(e) => setUlke(e.target.value)}>
